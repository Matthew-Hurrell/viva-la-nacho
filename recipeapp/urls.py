...
urlpatterns = [
    ...
    path('recipe/unlike/<int:pk>', views.UnlikeRecipe.as_view(),
         name='unlike_recipe'),
    path('recipe/edit/<int:pk>/', views.EditRecipe.as_view(),
         name='edit_recipe'),
    path('recipe/delete/<int:pk>/', views.DeleteRecipe.as_view(),
         name='delete_recipe'),
